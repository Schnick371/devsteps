...
**Commands Added**:
- `devsteps.viewMode.flat` - Switch to flat grouped view
- `devsteps.viewMode.hierarchical` - Switch to tree hierarchy view
- `devsteps.hierarchy.scrum` - Show only Scrum hierarchy
- `devsteps.hierarchy.waterfall` - Show only Waterfall hierarchy
- `devsteps.hierarchy.both` - Show both hierarchies
