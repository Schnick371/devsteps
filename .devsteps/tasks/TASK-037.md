...
import type { ViewMode, HierarchyType, FilterState, SortState } from '../treeView/devstepsTreeDataProvider';
...
2. ✅ Export types from `devstepsTreeDataProvider.ts` (ViewMode, HierarchyType)
