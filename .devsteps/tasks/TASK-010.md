...
1. **devsteps.filterByStatus** - Multi-select status filtering:
...
2. **devsteps.filterByPriority** - Multi-select priority filtering:
   - 4 levels: critical 🔴/high 🟠/medium 🟡/low ⚪
   - Multiple selection supported
   - Visual priority indicators

3. **devsteps.filterByType** - Multi-select type filtering:
   - 8 item types: epic/story/task/bug/feature/requirement/spike/test
   - Multiple selection for flexible views

4. **devsteps.clearFilters** - Reset all filters:
...
**devsteps.sort** - Interactive two-step sorting:
