...
```xml
<!-- resources/icons/devsteps-activitybar.svg -->
  ...
  "contributes": {
    "viewsContainers": {
      "activitybar": [{
        "id": "devsteps",
        "title": "DevSteps",
        "icon": "resources/icons/devsteps-activitybar.svg"
      }]
    }
  }
}
...
├── resources/
│   └── icons/
│       └── devsteps-activitybar.svg  # Only custom icon needed
└── src/
    └── utils/
