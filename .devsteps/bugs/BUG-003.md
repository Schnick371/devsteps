...
// - devsteps.viewMode (values: "flat" | "hierarchical")
// - devsteps.hideDone (values: true | false)
// - devsteps.hierarchyType (values: "scrum" | "waterfall" | "both")
// - devsteps.sortBy (values: "name" | "path" | "status")
```
...
vscode.commands.executeCommand('setContext', 'devsteps.viewMode', 'flat');
```
...
},
{
  ...
  "when": "view == devsteps.itemsView && devsteps.viewMode == 'flat'",
  "group": "1_view"
}
```
...
```json
{
  "command": "devsteps.viewMode.flat.active",
  "title": "✓ View as List"
},
{
  "command": "devsteps.viewMode.flat.inactive",
  "title": "View as List"
}
```
