...
## Vision
DevSteps automatically detects and reports project data problems, guiding users to maintain healthy, consistent project structures - like a "doctor" for your project data.
...
## Problem
Currently DevSteps creates new items with validation (EPIC-005), but doesn't check EXISTING data for:
...
## Solution
Extend `devsteps doctor` command to comprehensively check project health across multiple dimensions.
...
## Success Criteria
- Developer runs `devsteps doctor` and gets clear report
