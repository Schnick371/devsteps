...
Fully obsolete — STORY-268 eliminated `devsteps_docs_new` entirely. Doc items are created via the generic `add` command. Diataxis skeletons auto-generated by `addItem()` based on tags/title."