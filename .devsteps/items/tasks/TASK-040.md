...
Integrated validation engine into MCP devsteps-link handler with AI-friendly error responses.

### Implementation

**File:** `packages/mcp-server/src/handlers/devsteps-link.ts`
- Added `validateRelationship` import from @devsteps/shared
...
1. **Validation Integration**
   - Loads methodology from .devsteps/config.json
