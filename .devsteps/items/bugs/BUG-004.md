...
## Problem
Commands showed "command 'devsteps.viewMode.hierarchical' not found" and "command 'devsteps.toggleHideDone' not found" errors when toolbar buttons clicked.
...
```typescript
vscode.commands.registerCommand('devsteps.viewMode.flat', () => {
...
- ✅ TreeView registered when .devsteps exists
