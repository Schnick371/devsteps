...
| PS7-REMOTE-ENFORCEMENT.md | reference | ⬜ Frontmatter fehlt |
| NODE-TYPES.md | reference | ⬜ Frontmatter fehlt |
| SELF-EXTRACTING-INSTALLER.md | how-to | ⬜ Frontmatter fehlt (BUG-117) |
| CLI-API-ARCHITECTURE.md | reference | ⬜ Frontmatter fehlt |
| CONFIG-MANAGEMENT.md | reference | ⬜ Frontmatter fehlt |
| WORKSPACE-CONFIGURATION.md | how-to | ⬜ Frontmatter fehlt |
| BACKUP-RESTORE-WORKFLOWS.md | how-to | ⬜ Frontmatter fehlt |
| PS51-BOOTSTRAP-COMPATIBILITY-MATRIX.md | reference | ⬜ Frontmatter fehlt |
| MODULE-DEPLOYMENT-STRATEGY.md | explanation | ⬜ Frontmatter fehlt |
| *(38 weitere — organische Migration)* | mixed | ⬜ P3 |
