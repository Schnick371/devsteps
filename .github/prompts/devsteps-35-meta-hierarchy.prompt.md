...
- The `devsteps-85-classify-items` prompt has been run and classification is complete

**Do NOT use this prompt for:** functional categorization (use `devsteps-85-classify-items`) or
ad-hoc tag management (use `mcp_devsteps_update` directly via `devsteps-40-start-work`).
...
## How This Differs from `devsteps-85-classify-items`

| Dimension | `devsteps-35-meta-hierarchy` | `devsteps-85-classify-items` |
|---|---|---|
