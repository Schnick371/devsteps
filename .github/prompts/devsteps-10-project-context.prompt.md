...
**Aspect Files:** Generated by `doc-context-sync.prompt.md` from codebase analysis
...
- Progressive: overview → relevant → deep
...
**Status updates:** Loading → Loaded aspects → Skipped count → Ready statement
...
- `doc-context-sync.prompt.md` - Generates context documentation
