...
| --------------------------- | ------------------------- |
| Need deep planning first    | `devsteps-30-plan-work`   |
| Single item only            | `devsteps-40-start-work`  |
| Kanban pull, no ceremony    | `devsteps-50-rapid-cycle` |
| Review only                 | `devsteps-60-review`      |
| Investigation / archaeology | `devsteps-25-investigate` |
| Deep research & best practices | `devsteps-20-research` |
