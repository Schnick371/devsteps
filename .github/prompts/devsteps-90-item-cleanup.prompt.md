...
- devsteps-45-sprint.prompt.md - Implementation workflow (this is planning counterpart)
- devsteps-30-plan-work.prompt.md - Creating NEW work items, Spike transitions
- devsteps-40-start-work.prompt.md - Bug lifecycle, quality gates
