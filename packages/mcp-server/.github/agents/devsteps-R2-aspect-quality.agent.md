...
- **Role**: `aspect` — Aspect Analyst
- **Dispatched by**: coord (Ring 2 cross-validation) · `devsteps-R1-analyst-quality` (internal quality analysis) · `devsteps-R5-gate-reviewer` (review gate)
