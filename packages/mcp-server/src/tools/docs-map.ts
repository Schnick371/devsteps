...
export const docReadContentTool: Tool = {
  ...
  description:
    'Read the full markdown content of a DOC item by ID. Returns structured metadata including headings[], word_count, diataxis_type, and frontmatter (if YAML frontmatter is present). ' +
    'Frontmatter fields: diataxis, related_items, status, author, tags. Frontmatter diataxis overrides tag-based heuristic. ' +
