...
### Changed
- Version bump required by VS Code Marketplace (replaces 1.0.1 — same pre-release channel)
- Uses `@schnick371/devsteps-mcp-server@next` (1.0.0-next.2) via explicit `"channel": "next"` field
