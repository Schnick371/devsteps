...
- **devsteps.instructions.md**: Core methodology, hierarchy rules, MCP tools
...
**Related:** devsteps-10-plan-work (batch planning), devsteps-20-start-work (backlog execution), devsteps.instructions.md (core methodology)
