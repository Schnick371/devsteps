...
program
  .command('add')
  .description(
    'Add a new item (epic, story, task, requirement, feature, bug, spike, test, doc). Doc items with Diataxis tags or title prefixes (Tutorial:, How to, Reference:, ADR:, Research:) get auto-generated skeletons.'
  )
