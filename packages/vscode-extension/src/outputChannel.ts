...
/**
 * Centralized logging system for DevCrumbs extension
...
export class DevCrumbsLogger {
   ...
   */
  public static getInstance(): DevCrumbsLogger {
    if (!DevCrumbsLogger.instance) {
      DevCrumbsLogger.instance = new DevCrumbsLogger();
    }
    return DevCrumbsLogger.instance;
  }
 ...
 */
export const logger = DevCrumbsLogger.getInstance();
