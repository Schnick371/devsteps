...
```typescript
// In extension.ts
vscode.lm.registerMcpServerDefinitionProvider('devcrumbs', {
...
**Activation:**
- Extension activates (`onStartupFinished` or `workspaceContains:.devcrumbs`)
...
**Phase 1 (MVP):**
1. **Tools**: Expose DevCrumbs operations (add, list, update, link)
