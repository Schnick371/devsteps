...
## Overview
Full VS Code extension providing native IDE integration for DevCrumbs projects with TreeView, WebView, Commands, and automatic MCP server configuration.
...
- @devcrumbs/shared for business logic
- @devcrumbs/mcp-server bundled for auto-start
- esbuild for bundling

## Acceptance Criteria
- ✅ Extension activates when .devcrumbs/ folder detected
