...
```json
{
  "command": "devcrumbs.toggleShowRelations",
...
```typescript
export class DevCrumbsTreeDataProvider {
...
export class TreeViewStateManager {
  private static readonly KEYS = {
    // ... existing keys
    SHOW_RELATIONS: 'devcrumbs.treeView.showRelations',
  };
...
context.subscriptions.push(
  vscode.commands.registerCommand('devcrumbs.toggleShowRelations', () => {
