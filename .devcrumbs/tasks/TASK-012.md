...
## Objectives
Provide comprehensive configuration UI for DevCrumbs extension with settings contribution and validation.
...
```json
{
  "devcrumbs.treeView.defaultMode": {
    "type": "string",
    "enum": ["flat", "hierarchical"],
    "default": "flat",
    "description": "Default view mode for TreeView"
  },
  "devcrumbs.treeView.defaultHierarchy": {
    "type": "string",
    "enum": ["scrum", "waterfall", "both"],
    "default": "both",
    "description": "Which hierarchies to show by default"
  },
  "devcrumbs.treeView.showCompletedItems": {
    "type": "boolean",
    "default": true,
    "description": "Show completed items in TreeView"
  },
  "devcrumbs.treeView.autoRefresh": {
    "type": "boolean",
    "default": true,
    "description": "Automatically refresh when .devcrumbs files change"
  }
}
```
...
```json
{
  "devcrumbs.dashboard.defaultSections": {
    "type": "array",
    "items": {
      "type": "string",
...
```json
{
  "devcrumbs.icons.colorPriority": {
    "type": "boolean",
    "default": true,
    "description": "Apply priority colors to icons"
  },
  "devcrumbs.decorations.enabled": {
    "type": "boolean",
    "default": true,
...
```json
{
  "devcrumbs.shortcuts.enabled": {
    "type": "boolean",
    "default": true,
    "description": "Enable DevCrumbs keyboard shortcuts"
  }
}
```
...
```json
{
  "devcrumbs.logging.level": {
    "type": "string",
    "enum": ["error", "warn", "info", "debug"],
    "default": "info",
    "description": "Output channel logging level"
  },
  "devcrumbs.logging.showOutputOnError": {
    "type": "boolean",
    "default": true,
    ...
    "configuration": {
      ...
      "properties": {
        ...
        "devcrumbs.treeView.autoRefresh": {
          "type": "boolean",
          "default": true,
          "description": "Automatically refresh TreeView when .devcrumbs files change",
          "order": 4
        },
        "devcrumbs.dashboard.defaultSections": {
          "type": "array",
...
export class SettingsManager {
  private static readonly CONFIG_SECTION = 'devcrumbs';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidChangeConfiguration(e => {
      if (e.affectsConfiguration('devcrumbs.treeView')) {
        treeDataProvider.refresh();
      }
      
      if (e.affectsConfiguration('devcrumbs.decorations.enabled')) {
        decorationProvider.refresh();
      }
      
      if (e.affectsConfiguration('devcrumbs.logging.level')) {
...
```json
{
  "command": "devcrumbs.settings.open",
  "title": "DevCrumbs: Open Settings"
},
{
  "command": "devcrumbs.settings.reset",
  "title": "DevCrumbs: Reset to Default Settings"
}
```

```typescript
vscode.commands.registerCommand('devcrumbs.settings.open', () => {
  vscode.commands.executeCommand('workbench.action.openSettings', 'devcrumbs');
});

vscode.commands.registerCommand('devcrumbs.settings.reset', async () => {
  const answer = await vscode.window.showWarningMessage(
    'Reset all DevCrumbs settings to default?',
    'Yes', 'No'
  );
  ...
  if (answer === 'Yes') {
    ...
    // ... more resets
    vscode.window.showInformationMessage('DevCrumbs settings reset to defaults');
  }
});
```
