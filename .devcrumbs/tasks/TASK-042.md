...
## Solution
Document mandatory commit workflow in `.github/instructions/devcrumbs.instructions.md`.

## Implementation

### 1. Update devcrumbs.instructions.md
...
5. **Never Edit .devcrumbs/:** Use tools only
```
