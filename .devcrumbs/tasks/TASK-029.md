...
### Backup
- [ ] Create full backup: `tar -czf devcrumbs-backup-$(date +%Y%m%d-%H%M%S).tar.gz .`
...
**What to KEEP (.devcrumbs/ tracked):**
- ✅ `.devcrumbs/` - Work items (show workflow usage)
...
- .devcrumbs/tasks/TASK-028.* (INCLUDE!)
```
